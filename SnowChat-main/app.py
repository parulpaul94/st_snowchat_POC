...
with st.sidebar:
    ...
    st.write("**Snowflake User:**", os.environ["SNOWFLAKE_USER"])
    st.write("**Snowflake Account:**", os.environ["SNOWFLAKE_ACCOUNT"])
    st.write("**Snowflake Warehouse:**", os.environ["SNOWFLAKE_WAREHOUSE"])
    st.write("**Snowflake Schema:**", os.environ["SNOWFLAKE_SCHEMA"])
    st.write("**Snowflake Database:**", os.environ["SNOWFLAKE_DATABASE"])

    # Printing to the console (for debugging purposes)
    print("USER:", os.environ["SNOWFLAKE_USER"])
    print("ACCOUNT:", os.environ["SNOWFLAKE_ACCOUNT"])
    print("WAREHOUSE:", os.environ["SNOWFLAKE_WAREHOUSE"])
    print("SCHEMA:", os.environ["SNOWFLAKE_SCHEMA"])
    print("DATABASE:", os.environ["SNOWFLAKE_DATABASE"])
